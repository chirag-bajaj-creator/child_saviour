...
export default function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // Validate role - only admins allowed on admin portal
      if (response.data.user.role !== 'admin') {
        setError(`Invalid credentials. Only admins can login here. You are a ${response.data.user.role}.`)
        setPassword('')
        return
      }
        ...
        {isLogin ? (
          <form onSubmit={handleLogin}>
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-lg mb-4 focus:outline-none focus:border-gray-900"
              required
            />
            <input
              type="password"
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-lg mb-6 focus:outline-none focus:border-gray-900"
              required
            />
            <button
              type="submit"
